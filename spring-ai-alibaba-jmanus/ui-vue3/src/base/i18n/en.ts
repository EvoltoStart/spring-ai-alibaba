...
const words: I18nType = {
  ...
  conversationManagement: {
    ...
    noConversationsHint: 'Click "New Conversation" to start chatting',
    loading: 'Loading...',
    retry: 'Retry',
    clearChat: 'Clear Chat',
    exportChat: 'Export Chat',
    clearChatConfirm: 'Are you sure you want to clear the current conversation? This action cannot be undone.',
    inputPlaceholder: 'Type a message... (Shift+Enter for new line, Enter to send)',
    send: 'Send',
    sending: 'Sending...',
    selectConversation: 'Select a conversation to start chatting',
    selectConversationHint: 'Or create a new conversation',
    user: 'User',
    ...
    cannotAcceptMessage: 'Conversation cannot accept new messages at this time',
    ...
    addMessageFailed: 'Failed to add message',
    loadFailed: 'Loading failed',
    searchFailed: 'Search failed',
    updateStatusFailed: 'Failed to update status',
    linkPlanFailed: 'Failed to link plan'
  },
